...
class PlateReader():
    ...
    def __init__(self, num_model_path, char_model_path, certainty_thresh=0.8):
        ...
        self.num_model = tf.keras.models.load_model(num_model_path)
        self.char_model = tf.keras.models.load_model(char_model_path)
    ...
    def process_image(self, img):
        ...
        """
        parking_plate, license_plate = self.plate_isolator.extract_plates(img)
        ...
        if (parking_plate is not None):
            try:
                ...
                certainty = prob_parking_num + prob_letter_left + \
                    prob_letter_right + prob_tens_digit + prob_ones_digit
